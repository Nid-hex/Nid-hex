...
```typescript
class Developer {
    name: string = "Nidhi Kumari";
    role: string = "Web Developer";
    location: string = "India";
    workingOnUrl: string = "https://github.com/Nid-hex/Form2Mail";
    learning: string[] = ["Reactjs", "Nodejs", "Git", "JavaScript"];
    askMeAbout: string[] = ["Web Dev", "App Dev"];
}
```
...
<div align="center">
  <a href="https://git.io/streak-stats"><img src="https://streak-stats.demolab.com?user=Nid-hex&theme=tokyonight" alt="GitHub Streak" /></a>
  &nbsp;&nbsp;
